    ...
    <div className="mt-3 flex flex-wrap gap-2.5">
      {valid.map((sl) => (
        <button
          ...
          className="cursor-pointer rounded bg-clay/15 px-4 py-2 font-display text-xs font-semibold uppercase tracking-wider text-clay transition-colors hover:bg-clay/25"
        >
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <main className={`mx-auto flex w-full max-w-4xl flex-1 flex-col items-center px-5 ${live ? "" : "justify-center"}`}>
        ...
        {live && (
          <div className="mt-8 w-full pb-44">
            {dash.kind === "gen" ? (
